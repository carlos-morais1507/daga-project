...
const KedetPage = () => {
  return (
    <>
      <Head>
        <title>Explore Daga - Kedet</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>
      <main className={`${inter.className} bg-slate-900 text-white scroll-smooth`}>
        <div className="bg-[url('/images/Kedet_tn.png')] h-[500px] w-full bg-no-repeat bg-cover bg-right-top backdrop-brightness-50 backdrop-blur-lg flex items-end">
          <div>
            <h1 className='text-[32px] lg:text-[68px] w-full bg-cyan-900 font-bold p-4 shadow-lg'>O reino que vende tudo</h1>
          </div>  
        </div>
        <div>
